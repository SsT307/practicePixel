...
def draw_color_pixel(color_string, turta):
    ...
    for _ in range(4):  # Draw a square pixel
        turta.forward(30)  # Adjust size as needed
        turta.right(90)
    turta.end_fill()
    turta.forward(30)  # Move to the right for the next pixel
    ...
    try:
        ...
        with open(file_name, 'r') as file:
            ...
            for line in file:
                ...
                turta.penup()
                turta.backward(30 * len(line))  # Move back to the start of the row
                turta.right(90)
                turta.forward(30)  # Move down to the next row
                turta.left(90)
                turta.pendown()
